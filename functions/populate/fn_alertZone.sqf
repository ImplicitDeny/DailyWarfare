...
if(LM_MISSION_POPULATE select 6) then { playSound3D[MISSION_ROOT + "sounds\sirene_alerte.ogg", objNull, false, LM_MISSION_POSITION, 6]; };
...
// Casernes
{
	_x spawn LM_fnc_gestionCaserne;
} forEach LM_MISSION_CASERNES;