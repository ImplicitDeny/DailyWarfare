...
if(isNil "_handle") then
{
	...
	// Stockage des valeurs dans le profil
	profileNamespace setVariable ["LM_MISSION_COUNT", LM_MISSION_COUNT];
	profileNamespace setVariable ["LM_MISSION_SUCCESS",LM_MISSION_SUCCESS];
	profileNamespace setVariable ["LM_MISSION_SIDES",LM_MISSION_SIDES];
	...
	profileNamespace setVariable ["LM_MISSION_FOBS",LM_MISSION_FOBS];
};
