...
_statement_reinit = {
	remoteExecCall ["LM_fnc_switchReinitValue", 2];
	systemChat "statement";
};
_modifier_reinit = {
...
//_actionReinit = ["reinitMission", format["Réinit. au prochain redémarrage : %1", "OUI"], "", _statement_reinit,{admin clientOwner > 0}] call ace_interact_menu_fnc_createAction;
_actionReinit = ["reinitMission", "Réinit. au prochain redémarrage : NON", "", _statement_reinit,{true},{},[],"",4,[false, false, false, false, false],_modifier_reinit] call ace_interact_menu_fnc_createAction;
