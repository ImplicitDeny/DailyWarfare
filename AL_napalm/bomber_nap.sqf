// by ALIAS
// null = [] execVM "AL_napalm\bomber_nap.sqf";
...
_avion_nap = [_origpos, _unghi, "B_Plane_CAS_01_F", civilian] call bis_fnc_spawnvehicle;
_veh_avion = _avion_nap select 0;
_veh_avion allowdamage false;
_veh_avion setPosATL [getPosATL _veh_avion select 0, getPosATL _veh_avion select 1, 300];
_veh_avion setcombatmode "BLUE";
_veh_avion setBehaviour "AWARE";
_veh_avion disableAI "TARGET";
_veh_avion disableAI "AUTOTARGET";
_veh_avion flyInHeight 200;
...
_wp1 setWaypointStatements ["true", "[this] execvm 'AL_napalm\alias_napalm_ini.sqf'"];
