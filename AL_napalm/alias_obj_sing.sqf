...
[[_nap_obj_b,_dir_xx/10,_dir_yy/10],"AL_napalm\alias_napalm_effect.sqf"] remoteExec ["BIS_fnc_execVM"];
...
sleep 3 + (random 3);
[[_nap_obj_b,_dir_xx/10,_dir_yy/10],"AL_napalm\alias_napalm_effect_sec.sqf"] remoteExec ["BIS_fnc_execVM"];

//[[_nap_obj_b,false,300,40,0.01,true,false],"ALfire\fire.sqf"] remoteExec ["BIS_fnc_execVM"];
